  ...
  exports.Scope = Scope = (function() {
    ...
    Scope.prototype.endLevel = function() {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        name = _ref2[_i];
        if (vars[name] === 'var') _results.push(vars[name] = 'reuse');
      }
      return _results;
    };
    ...
    Scope.prototype.freeVariable = function(type) {
      ...
      if (this.garbage.length) last(this.garbage).push(temp);
      return temp;
    };
    ...
    Scope.prototype.declaredVariables = function() {
      ...
      return ((function() {
        ...
        for (key in _ref2) {
          val = _ref2[key];
          if (val === 'var' || val === 'reuse') _results.push(key);
        }
        return _results;
      }).call(this)).sort();
    };
    ...
    Scope.prototype.assignedVariables = function() {
      ...
      for (key in _ref2) {
        val = _ref2[key];
        if (val.assigned) _results.push("" + key + " = " + val.value);
      }
      return _results;
    };
